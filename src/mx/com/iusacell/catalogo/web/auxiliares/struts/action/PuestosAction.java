 ...
 *
 */
public class PuestosAction extends Action {
	
	public PuestosAction() {
	}
	...
	private ActionForward home(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			return new  PuestosProxy().verLista(mapping,form,request,response);	
	}
	...
	private ActionForward agregar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			if (errors != null && errors.isEmpty()) {
				return new  PuestosProxy().agregar(mapping,form,request,response);	
			} else {
	...
	private ActionForward eliminar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			return new  PuestosProxy().eliminar(mapping,form,request,response);	
	}
	...
	private ActionForward modificar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			**********************************************************************************/
			...
			if (errors != null && errors.isEmpty()) {
				return new  PuestosProxy().modificar(mapping,form,request,response);	
			} else {
				saveErrors(request, errors);
				return mapping.findForward("home");
			}
	...
	private ActionForward consultar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			if (errors != null && errors.isEmpty()) {
				return new  PuestosProxy().consultar(mapping,form,request,response);	
			} else {
				saveErrors(request, errors);
				return mapping.findForward("home");
			}
