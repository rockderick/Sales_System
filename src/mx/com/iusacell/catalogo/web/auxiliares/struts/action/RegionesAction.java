 ...
 *
 */
public class RegionesAction extends Action {
	
	public RegionesAction() {
	}
	...
	private ActionForward home(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			return new  RegionesProxy().verLista(mapping,form,request,response);	
	}
	...
	private ActionForward agregar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			if (errors != null && errors.isEmpty()) {
				return new  RegionesProxy().agregar(mapping,form,request,response);	
			} else {
	...
	private ActionForward eliminar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			return new  RegionesProxy().eliminar(mapping,form,request,response);	
	}
	...
	private ActionForward consultar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			if (errors != null && errors.isEmpty()) {
				return new  RegionesProxy().consultar(mapping,form,request,response);	
			} else {
				saveErrors(request, errors);
				return mapping.findForward("home");
			}						
	...
	private ActionForward modificar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			if (errors != null && errors.isEmpty()) {
				return new  RegionesProxy().modificar(mapping,form,request,response);	
			} else {
				saveErrors(request, errors);
				return mapping.findForward("home");
			}						
