 ...
 *
 */
public class TipoCanalesAction extends Action {
	
	public TipoCanalesAction() {
	}
	...
	private ActionForward home(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			return new  TipoCanalesProxy().verLista(mapping,form,request,response);	
	}
	...
	private ActionForward agregar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			if (errors != null && errors.isEmpty()) {
				return new  TipoCanalesProxy().agregar(mapping,form,request,response);	
			} else {
	...
	private ActionForward eliminar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			return new  TipoCanalesProxy().eliminar(mapping,form,request,response);	
	}
	...
	private ActionForward modificar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			if (errors != null && errors.isEmpty()) {
				return new  TipoCanalesProxy().modificar(mapping,form,request,response);	
			} else {
				saveErrors(request, errors);
				return mapping.findForward("home");
			}				
	...
	private ActionForward consultar(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response) {
			...
			if (errors != null && errors.isEmpty()) {
				return new  TipoCanalesProxy().consultar(mapping,form,request,response);	
			} else {
				saveErrors(request, errors);
				return mapping.findForward("home");
			}				
