 ...
 *
 */
public class PersonalMovForm extends ValidatorForm implements Serializable{
	...
	private String pcNomClaveEmpleadoReferenciaSeek;  //String para almacenar el campo de Busqueda para la Clave de la referencia del Empleado
	...
	private String pcCveDivCambia;
	private String pcFchCambio; 
	
	private String pcCveHorario;
	private String pcDescHorario;
	private int claveSuperior;
	private int pcCveSupBase;
	private String pcFchReact;
	
	private String pcDistMAster;
	
	//Empty Constructor
	public PersonalMovForm() {
		setPcCveVendedor(0); 
		setPcCvePuesto(0);
		setPcCveSuperior(0); 
...
//		}
	 ...
	 * @return
	 */
	public String getPcFechaStatus() {
		return pcFechaStatus;
	}

	/**
	 * @param string
	 */
	public void setPcFechaStatus(String string) {
		pcFechaStatus = string;
	}
	 ...
	 * @return
	 */
	public String getPcCveDivCambia() {
		return pcCveDivCambia;
	}

	/**
	 * @param string
	 */
	public void setPcCveDivCambia(String string) {
		pcCveDivCambia = string;
	}
	 ...
	 * @return
	 */
	public int getClaveSuperior() {
		return claveSuperior;
	}

	/**
	 * @param i
	 */
	public void setClaveSuperior(int i) {
		claveSuperior = i;
	}
	 ...
	 * @param i
	 */
	public void setPcCveSupBase(int i) {
		pcCveSupBase = i;
	}
	 ...
	 * @param string
	 */
	public void setPcFchReact(String string) {
		pcFchReact = string;
	}
	 ...
	 * @param string
	 */
	public void setPcDistMAster(String string) {
		pcDistMAster = string;
	}
