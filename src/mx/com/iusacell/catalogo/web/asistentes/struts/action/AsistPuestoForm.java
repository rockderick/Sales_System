 ...
 *
 */
public class AsistPuestoForm extends ValidatorForm implements Serializable{
	...
	private int pcCvePuestoActual;
	private String pcDescPuestoActual;		//String para la descripcion del Puesto seleccionado en la forma 
	...
	private int pcCveSuperiorChg;
	
	private String pcFchMovimiento;
	
	//Empty Constructor
	public AsistPuestoForm() {
		...
		setPcCvePuestoActual(0);
		setPcDescPuestoActual(null);
		setPcCveSuperiorChg(0);
	}
	 ...
	 * @return
	 */
	public int getPcCvePuestoActual() {
		return pcCvePuestoActual;
	}

	/**
	 * @return
	 */
	public String getPcDescPuestoActual() {
		return pcDescPuestoActual;
	}

	/**
	 * @param i
	 */
	public void setPcCvePuestoActual(int i) {
		pcCvePuestoActual = i;
	}
	 ...
	 * @param string
	 */
	public void setPcDescPuestoActual(String string) {
		pcDescPuestoActual = string;
	}

	/**
	 * @return
	 */
	public int getPcCveSuperiorChg() {
		return pcCveSuperiorChg;
	}

	/**
	 * @param i
	 */
	public void setPcCveSuperiorChg(int i) {
		pcCveSuperiorChg = i;
	}
