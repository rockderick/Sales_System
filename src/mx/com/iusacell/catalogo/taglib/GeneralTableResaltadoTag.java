 ...
 * base de datos
 */
public class GeneralTableResaltadoTag extends TagSupport {
	...
	protected void generaCeldaTable(Object elemento, String color, int numRenglon, int numColumna, String funcionJavaScript) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, IOException{
		JspWriter writer = super.pageContext.getOut();
		if( numColumna == 0){
			writer.print(Html.cadenaCeldaResaltadaTable((String)anchosColumnasArray.get(numColumna), color, altoRenglon, (String)alineacionesColumnasArray.get(numColumna), convierteString(MethodUtils.invokeExactMethod(elemento, (String)metodosArray.get(numColumna), null), (String)metodosArray.get(numColumna)),funcionJavaScript));
		}else {
