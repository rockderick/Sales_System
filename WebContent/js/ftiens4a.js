...
// ***************************************************************** 
function Folder(folderDescription, hreference, href1) //constructor 
{ 
  //constant data 
  ...
  this.supButton = ICONPATH + "supButton.gif";
...
{ 
  ...
  { 
    ...
    docW = docW + this.buttonHTML(true) 
	if (this.href1 && this.href1 != "") 
    docW = docW + "<img id='supButtonIcon" + this.id + "' name='supButtonIcon" + this.id + "' src='" + this.supButton + "' border=0></a>"    
    else
    docW = docW + "</a>"
  } 
  else 
...
function linkExtraHTML(isTextLink)
{
  var docW = "";
  ...
  { 
	if (USEFRAMES)
	  docW = docW + "<a href='" + this.href1 + "' TARGET=\"basefrm\" "
	else
	  docW = docW + "<a href='" + this.href1 + "' TARGET=_top "
...
function gFld(description, hreference,href1) 
{ 
  folder = new Folder(description, hreference,href1);
  return folder;
} 
