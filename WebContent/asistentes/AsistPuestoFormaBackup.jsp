...
<BR><BR>
	...
	<TD BGCOLOR="#FFFFFF">
		...
		<TR><TD HEIGHT="20"  CLASS="txtContenidoBlanco" ALIGN="CENTER" >
			<B><bean:message key="asistPuesto.header"/></B>
		</TD></TR>
		</TABLE>
	</TD>
	</TR>
...
<logic:equal name="AsistPuestoForm" property="page" value="1">
	...
	<TR><TD>
		<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" BGCOLOR="#FFFFFF">
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistPuesto.pcNombreCompleto.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
		...
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistPuesto.pcDescPuesto.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<bean:write property="pcDescPuestoActual" name="AsistPuestoForm" />
			</TD>
		</TR>
		<TR BGCOLOR="#FFFFFF">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistente.pcCvePuesto.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
...
<logic:equal name="AsistPuestoForm" property="page" value="2">
	...
	<TR><TD>
		...
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistPuesto.pcDescPuestoActual.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<bean:write property="pcDescPuestoActual" name="AsistPuestoForm" />
			</TD>
		</TR>
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistPuesto.pcNombreSuperiorActual.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
...
<logic:equal name="AsistPuestoForm" property="page" value="3">
	...
	<TR><TD>
		...
		<TR BGCOLOR="#FFFFFF">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistPuesto.pcNombreSuperior.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
...
<logic:equal name="AsistPuestoForm" property="page" value="4">
	...
	<TR><TD>
		...
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistPuesto.pcNombreSuperiorReasignar.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
...
<logic:equal name="AsistPuestoForm" property="page" value="5">
	...
	<TR><TD>
		<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" BGCOLOR="#FFFFFF">
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistPuesto.pcNombreCompleto.resumen"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:hidden property="pcNombreCompleto" name="AsistPuestoForm"/>
				<html:hidden property="pcCveVendedor" name="AsistPuestoForm"/>
				<bean:write property="pcNombreCompleto" name="AsistPuestoForm"/>
		...
		<TR BGCOLOR="#FFFFFF">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistPuesto.pcDescPuesto.resumen"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:hidden property="pcCvePuesto" name="AsistPuestoForm" />
				<html:hidden property="pcDescPuesto" name="AsistPuestoForm" />
				<bean:write property="pcDescPuesto" name="AsistPuestoForm" />
		...
		<logic:equal name="AsistPuestoForm" property="pcCveSuperiorChg" value="1">
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistPuesto.pcNombreSuperior.resumen"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
		...
		<logic:notEqual name="AsistPuestoForm" property="pcNombreSuperiorReasignar" value="">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistPuesto.pcNombreSuperiorReasignar.resumen"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:hidden name="AsistPuestoForm" property="pcCveSuperiorReasignar" />
				<html:hidden name="AsistPuestoForm" property="pcNombreSuperiorReasignar" />
				<bean:write name="AsistPuestoForm" property="pcNombreSuperiorReasignar" />
		...
		<logic:equal name="AsistPuestoForm" property="pcNombreSuperiorReasignar" value="">
			<TD COLSPAN="2"  CLASS="txtContenidoBold"><bean:message key="asistPuesto.pcNombreSuperiorSinReasignar.resumen"/></TD>
		</logic:equal>
		</TR>
		</logic:equal>
		<logic:equal name="AsistPuestoForm" property="pcCveSuperiorChg" value="0">
...
<!--html:javascript formName="AsistPuestoForm" dynamicJavascript="true" staticJavascript="true"/-->
</BODY>
</html:html>
