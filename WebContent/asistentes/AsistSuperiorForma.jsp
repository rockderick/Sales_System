...
<BR><BR>
	...
	<bean:define id="userSession" name="USER" type="mx.com.iusacell.catalogo.modelo.UserSessionVO"/>	<TABLE WIDTH="700" BORDER="0" align="center" id=borde>
      <TR>
        <TD HEIGHT="20"><h3><bean:message key="asistSuperior.header"/></h3></TD>
      </TR>
    </TABLE>
	<BR>
...
<logic:equal name="AsistSuperiorForm" property="page" value="1">
	...
	<TR><TD>		<TABLE WIDTH="700" align="center">	<TR bgcolor="#F9F9F9">
		...
		<TR BGCOLOR="#FFFFFF">
			<TD WIDTH="10%"  CLASS="txtContenidoRojo"><bean:message  key="asistente.pcNomClaveEmpleadoReferenciaSeek.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:text property="pcNomClaveEmpleadoReferenciaSeek" name="AsistPuestoForm" maxlength="40" size="30" value="" onchange="this.value=this.value.toUpperCase()"/>
			</TD>
		</TR>
		 <TR bgcolor="#F9F9F9">
				<TD WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
...
<logic:equal name="AsistSuperiorForm" property="page" value="2">
	...
	<TR><TD>		<TABLE WIDTH="700" align="center">	<TR bgcolor="#F9F9F9">
		...
		<TR BGCOLOR="#FFFFFF">
			<TD WIDTH="10%"  CLASS="txtContenidoRojo"><bean:message key="asistSuperior.pcNombreSuperior.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
...
<logic:equal name="AsistSuperiorForm" property="page" value="4">
	<table width="80%" cellpadding="0" cellspacing="0" border="0" align="center">
	<TR><TD>		<TABLE WIDTH="700" align="center">	<TR bgcolor="#F9F9F9">
			<TD WIDTH="10%"  CLASS="txtContenidoRojo"><bean:message key="asistSuperior.pcNombreCompleto.resumen"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:hidden property="pcNombreCompleto" name="AsistSuperiorForm"/>
				<html:hidden property="pcCveVendedor" name="AsistSuperiorForm"/>
				<bean:write property="pcNombreCompleto" name="AsistSuperiorForm"/>
		...
		<TR BGCOLOR="#FFFFFF">
			<TD WIDTH="10%"  CLASS="txtContenidoRojo"><bean:message key="asistSuperior.pcDescPuesto.resumen"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:hidden property="pcCvePuesto" name="AsistSuperiorForm" />
				<html:hidden property="pcDescPuesto" name="AsistSuperiorForm" />
				<bean:write property="pcDescPuesto" name="AsistSuperiorForm" />
		...
		<TR bgcolor="#F9F9F9">
			<TD WIDTH="10%"  CLASS="txtContenidoRojo"><bean:message key="asistSuperior.pcNombreSuperior.resumen"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:hidden name="AsistSuperiorForm" property="pcCveSuperior" />
				<html:hidden name="AsistSuperiorForm" property="pcNombreSuperior" />
				<bean:write name="AsistSuperiorForm" property="pcNombreSuperior" />
		...
		<logic:present name="AsistSuperiorForm" property="pcNombreSuperiorReasignar">
			<TD WIDTH="10%"  CLASS="txtContenidoRojo"><bean:message key="asistSuperior.pcNombreSuperiorReasignar.resumen"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:hidden name="AsistSuperiorForm" property="pcCveSuperiorReasignar" />
				<html:hidden name="AsistSuperiorForm" property="pcNombreSuperiorReasignar" />
				<bean:write name="AsistSuperiorForm" property="pcNombreSuperiorReasignar" />
		...
		<logic:notPresent name="AsistSuperiorForm" property="pcNombreSuperiorReasignar">
			<TD COLSPAN="2"  CLASS="txtContenidoRojo"><bean:message key="asistSuperior.pcNombreSuperiorSinReasignar.resumen"/></TD>
		</logic:notPresent>
		</TR>
		<TR BGCOLOR="#FFFFFF">
			<TD WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
