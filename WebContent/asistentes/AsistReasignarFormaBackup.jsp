...
<BR><BR>
	...
	<TD BGCOLOR="#FFFFFF">
		...
		<TR><TD HEIGHT="20"  CLASS="txtContenidoBlanco" ALIGN="CENTER" >
			<B><bean:message key="asistReasignar.header"/></B>
		</TD></TR>
		</TABLE>
	</TD>
	</TR>
	...
	<TD>
		...
		<TR BGCOLOR="#E0E1E3">
		 ...
		 <TR bgcolor="#FFFFFF">
				...
				<html:button property="boton" styleClass="boton" onclick="goToBuscar(AsistReasignarForm,'vendedores')"><bean:message key="button.buscar"/></html:button>
		 		</TD>
		 </TR>
		 </TABLE>
	</TD></TR></table>	
...
<logic:present name="tablaSubordinados">
	<bean:define id="tablaSubordinados" name="tablaSubordinados" type="java.util.ArrayList"/>
		...
		<TR BGCOLOR="#E0E1E3">
		 ...
		 <TR bgcolor="#FFFFFF">
				<TD WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
				<html:button property="boton" styleClass="boton" onclick="goToBuscar(AsistReasignarForm,'superior_reasignar')"><bean:message key="button.buscar"/></html:button>
		 		</TD>
		 </TR>
<logic:messagesPresent>
		<TR><TD CLASS="errormessagerojo" colspan="2">
...
<logic:equal name="AsistReasignarForm" property="page" value="2">
	...
	<TR><TD>
		...
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistente.pcFchMovimiento.displayname" /> <bean:message key="mascara.fecha"/>: </TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
...
<logic:equal name="AsistReasignarForm" property="page" value="3">
	...
	<TR><TD>
		<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" BGCOLOR="#FFFFFF">
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistReasignar.pcNombreCompleto.resumen"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:hidden property="pcNombreCompleto" name="AsistReasignarForm"/>
				<html:hidden property="pcCveVendedor" name="AsistReasignarForm"/>
				<bean:write property="pcNombreCompleto" name="AsistReasignarForm"/>
		...
		<TR BGCOLOR="#FFFFFF">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistReasignar.pcDescPuesto.resumen"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:hidden property="pcCvePuesto" name="AsistReasignarForm" />
				<html:hidden property="pcDescPuesto" name="AsistReasignarForm" />
				<bean:write property="pcDescPuesto" name="AsistReasignarForm" />
		...
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="asistReasignar.pcNombreSuperiorReasignar.resumen"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:hidden name="AsistReasignarForm" property="pcCveSuperiorReasignar" />
				<html:hidden name="AsistReasignarForm" property="pcNombreSuperiorReasignar" />
				<bean:write name="AsistReasignarForm" property="pcNombreSuperiorReasignar" />
...
<!--html:javascript formName="AsistReasignarForm" dynamicJavascript="true" staticJavascript="true"/-->
</BODY>
</html:html>
