...
<BR><BR>
	...
	<TD BGCOLOR="#FFFFFF">
		...
		<TR>
		<TD HEIGHT="20"  CLASS="txtContenidoBlanco" ALIGN="CENTER" ><B><bean:message key="accsMgr.main"/> </B></TD>
		</TR>
		</TABLE>
	</TD>
	</TR>
...
<BR><BR>
	...
	<TD>
		...
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="accsMgr.cuentas.displayname"/> : </TD>
			...
			<bean:define id="tablaCuentas" name="tablaCuentas" type="java.util.ArrayList"/>	
				<fsj:comboGeneralEstaticoTag
			    	name = "pcCveUsuario"
					lista='<%= tablaCuentas %>'
					valueMethodName = "getPcCveUsuario"
		...
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="accsMgr.division.displayname"/> : </TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
		...
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="accsMgr.roles.displayname"/> : </TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
		...
		<TR BGCOLOR="#E0E1E3">
			...
			<bean:define id="tablaPermisos" name="tablaPermisos" type="java.util.ArrayList"/>	
				<fsj:generalHomeTableEstatico
					...
					metodos="getPcUserid,getPcDescDiv,getPcDescRol,getPcDescStatus"
					...
					camposExtras='getPcUserid=user,getPcCveRol=rol,getPcCveDiv=div,getPcStatus=status'
