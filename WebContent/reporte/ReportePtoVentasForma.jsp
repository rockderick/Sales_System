...
ICONPATH = '../icons/' 
			...
			<logic:present name="textJavaScriptPtoVenta">
				<bean:define id="arbol" name="textJavaScriptPtoVenta" type="java.lang.String"/>
				<bean:write name="arbol" filter="false"/>
			</logic:present>
			<logic:notPresent name="textJavaScriptPtoVenta">
...
<BR><BR>
	<html:form method="post" action="ReportePtoVentasAction" method="POST" onsubmit="return validateReporteForm(this);"> 
	<bean:define id="ReportePtoVentasForm" name="ReportePtoVentasForm" type="mx.com.iusacell.catalogo.web.reporte.struts.action.ReportePtoVentasForm"/>
	<bean:define id="divisionUsuario" name="USER" type="mx.com.iusacell.catalogo.modelo.UserSessionVO"/>	<TABLE WIDTH="700" BORDER="0" align="center" id=borde>
      <TR>
        <TD HEIGHT="20"><h3><bean:message key="reporteForm.ptoventa.header"/></h3></TD>
      </TR>
    </TABLE>
	<BR>
	...
	<TABLE WIDTH="700" align="center">	
	  <TR bgcolor="#FFFFFF">
		...
		<TR bgcolor="#F9F9F9">
			...
			/>
			<html:hidden name="ReportePtoVentasForm" property="pcDescDivisionSeek" />
			</TD>
		</TR>
		<TR BGCOLOR="#FFFFFF">
			<TD WIDTH="10%"  CLASS="txtContenidoRojo"><bean:message key="reporteForm.pcCveVendedorSeek.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:text property="pcCveVendedorSeek" name="ReportePtoVentasForm" maxlength="40" size="30" value="" onchange="this.value=this.value.toUpperCase()"/>
			</TD>
		</TR>
		 <TR bgcolor="#F9F9F9">
				<TD WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
				<html:button property="boton" styleClass="boton" onclick="goToBuscarReporte(ReportePtoVentasForm)"> <bean:message key="button.buscar"/></html:button>
		 		</TD>
		 		<TD WIDTH="20%" ALIGN="CENTER" CLASS="txtContenido">
				<html:button property="boton" styleClass="boton" onclick="goToExcel(ReportePtoVentasForm,'excel')">Reporte Excel</html:button>
				</TD>
				<td>
					<logic:present name="ligaPtoVenta">
			 		<bean:define name="ligaPtoVenta" id="liga"/>
