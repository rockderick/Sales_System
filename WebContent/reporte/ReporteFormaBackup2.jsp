...
<BR><BR>
	...
	<TABLE WIDTH="700" align="center">	
	  <TR bgcolor="#FFFFFF">
		...
		<TR bgcolor="#F9F9F9">
			<TD WIDTH="10%"  CLASS="txtContenidoRojo"><bean:message key="repoteForm.pcCveDivisionSeek.displayname"/> :</TD>
...
<logic:messagesPresent>
		<TR><TD height="35" colspan="2" CLASS="errormessagerojo">
		   ...
		   <html:messages id="error">
		      <img src="<%= request.getContextPath()%>/images/bullet_cuadro_rojo.gif" width="6" height="6"> <bean:write name="error"/></li>
		   </html:messages>
