...
<BR><BR>
	...
	<TABLE WIDTH="700" BORDER="0" align="center" id=borde>
      <TR>
        <TD HEIGHT="20"><h3><bean:message key="regionesForm.header"/></h3></TD>
      </TR>
    </TABLE>
	<BR>
...
<logic:present name="noData">
	...
	<TD>		<TABLE WIDTH="700" align="center">	<TR bgcolor="#F9F9F9">
			<TD WIDTH="10%"  CLASS="txtContenidoRojo"><bean:message key="regionesForm.pcDescRegion.displayname"/> :</TD>
