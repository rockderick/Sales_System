...
<style>
   ...
   TD {
		...
		function updateTable(valor){
			...
			//changePcCvePuesto(valor,'clave');
			//changePcDescPuesto(valor,'puesto');
			changeListPcCvePuesto(form,valor);
			//if( window.mmIsOpera ) (document.getElementById("eliminar").style.visibility = 'visible');
			//if (document.all) (document.all.eliminar.style.visibility = 'visible');
			//if (document.getElementById) (document.getElementById("eliminar").style.visibility = 'visible');
		}
...
<BR><BR>
	...
	<TD BGCOLOR="#FFFFFF">
		...
		<TR>
		<TD HEIGHT="20"  CLASS="txtContenidoBlanco" ALIGN="CENTER" ><B><bean:message key="puestosArbolForm.header"/></B></TD>
		</TR>
		</TABLE>
	</TD>
	</TR>
...
<div style="position:absolute; top:0; left:0; visibility:hidden"><table border=0><tr><td><font size=-2><a style="font-size:7pt;text-decoration:none;color:silver" href="http://www.treemenu.net/" target=_blank>JavaScript Tree Menu</a></font></td></tr></table></div>
	...
	<TD valign="top" width="55%">
			...
			<table border=0 width="100%">
			<tr bgcolor="#E0E1E3"><td class="txtContenido" width="25%"><bean:message key="puestosArbolForm.pcDescPuestos.displayname"/></td><td class="txtContenido">
<logic:present name="tablaPuestos">
	<bean:define id="tablaPuestos" name="tablaPuestos" type="java.util.ArrayList"/>
			...
			<!--tr bgcolor="#E0E1E3">
				<td WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
					<html:button property="boton" styleClass="boton" onclick="goToAgregar(PuestosArbolForm)"><bean:message key="puestosArbolForm.button.agregar"/></html:button>
				</td>
				<td WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
					<html:button property="boton" styleClass="boton" onclick="goToModificar(PuestosArbolForm)"><bean:message key="puestosArbolForm.button.modificar"/></html:button>
		 		</td>
			</tr-->
			<tr bgcolor="#FFFFFF">
				<td WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
