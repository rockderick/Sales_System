...
<BR><BR>
	...
	<TABLE WIDTH="700" BORDER="0" align="center" id=borde>
		<TR>
		<TD HEIGHT="20"><h3><bean:message key="tipoCanalesForm.header"/></h3></TD>
		</TR>
</TABLE>
	...
	<TD>		<TABLE WIDTH="700" align="center">	<TR bgcolor="#FFFFFF">
		...
		<TR>
			...
			<fsj:generalHomeTable
				...
				titulos="Clave Tipo de Canal, Tipo de Canal"
				metodos="getPcCveTpCanal,getPcDescTpCanal"
				anchosColumnas="45%,45%"
...
<logic:present name="noData">
	...
	<TD>		<TABLE WIDTH="700" align="center">	<TR bgcolor="#F9F9F9">
			<TD WIDTH="10%"  CLASS="txtContenidoRojo"><bean:message key="tipoCanalesForm.pcDescTpCanal.displayname"/> :</TD>
