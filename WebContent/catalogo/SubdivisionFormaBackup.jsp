...
<BR><BR>
	...
	<TD BGCOLOR="#FFFFFF">
		...
		<TR>
		<TD HEIGHT="20"  CLASS="txtContenidoBlanco" ALIGN="CENTER" ><B><bean:message key="subdivisionForm.buscar"/> </B></TD>
		</TR>
		</TABLE>
	</TD>
	</TR>
...
<logic:present name="noData">
	...
	<TD BGCOLOR="#FFFFFF">
		<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="0" BGCOLOR="#CC0000">
		<TR>
		<TD HEIGHT="20"  CLASS="txtContenidoBlanco" ALIGN="CENTER" ><B><bean:message key="subdivisionForm.header"/></B></TD>
		</TR>
		</TABLE>
	</TD>
	</TR>
...
<logic:notEmpty name="SubdivisionForm" property="pcCveDivision">
	...
	<TD>
		<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" BGCOLOR="#FFFFFF">		
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="subdivisionForm.pcDescSubdiv.displayname"/></TD>
		...
		<TR BGCOLOR="#FFFFFF">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="subdivisionForm.pcCveDivision.displayname"/>:</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
...
<!--html:javascript formName="SubdivisionForm" dynamicJavascript="true" staticJavascript="true"/-->
</BODY>
</html:html>
