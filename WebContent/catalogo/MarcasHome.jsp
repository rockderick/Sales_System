...
<title><bean:message key="empresaForm.title"/></TITLE>
		...
		function goToEliminar(form) {
			...
			if(rad!=null){
				...
				alert("Debe buscar un registro para Eliminar");
			}
		}			
...
<BODY bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="3" marginwidth="0" marginheight="0" onLoad="window_onload(MarcasForm)">
...
<BR><BR>												 
	...
	<TABLE WIDTH="700" BORDER="0" align="center" id=borde>
      <TR>
        <TD HEIGHT="20"><h3>Catálogo de Marcas</h3></TD>
      </TR>
    </TABLE>
    ...
    <table width="765" border="0" cellspacing="0" cellpadding="5" align="center">
		...
		<td width="135" align="right"><TD WIDTH="40%"  CLASS="txtContenidoRojo">Descripción de Marca :</TD></td>
			<td width="237" align="left">
				<html:text  property="pcDescMarca" size="15" maxlength="16" onchange="this.value=this.value.toUpperCase()"/>
			</td> 
		...
		<table width="765" border="0" cellspacing="0" cellpadding="5" align="center">
			...
			<TR bgcolor="#FFFFFF" ALIGN="CENTER">
				<TD WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
				 	<INPUT TYPE="button" NAME="" VALUE="Buscar" CLASS="boton" onClick="goToBuscar(MarcasForm)">
				 </TD>
			</TR>
		</table>
	...
	<div align="center">
	<div style="height:220;width:65%;overflow:scroll;visibility:visible">
		
				
				<fsj:generalHomeTable
					queryId="<%=Q.OBTENER_MARCAS%>"	
					...
					witdhColumnRadio="10%"
					radioName="identif"
					parametrosQuery='<%=new Object[]{ getValor(request,"pcDescMarca")}%>'
	...
	<TR>
	        	...
	        	<INPUT TYPE="button" NAME="buscaBtn" VALUE="&nbsp;Agregar&nbsp;" CLASS="boton"
  				onClick="goToAgregar(MarcasForm)">
	   			</TD>
	        	...
	        	<INPUT TYPE="button" NAME="buscaBtn" VALUE="&nbsp;Modificar&nbsp;" CLASS="boton"
  				onClick="goToModificar(MarcasForm)">
	   			...
	   			<TD width="900" align="center"> 
	        	<INPUT TYPE="button" NAME="buscaBtn" VALUE="&nbsp;Eliminar&nbsp;" CLASS="boton"
  				onClick="goToEliminar(MarcasForm)">
	   			</TD>
