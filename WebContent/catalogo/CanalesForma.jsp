...
<BR><BR>
	...
	<bean:define id="divisionUsuario" name="USER" type="mx.com.iusacell.catalogo.modelo.UserSessionVO"/>	
      <TR>
        <TD HEIGHT="20"><h3><bean:message key="canalesForm.buscar"/></h3></TD>
      </TR>
    </TABLE>
	<BR>
...
<logic:present name="noData">
	...
	<br>	<TABLE WIDTH="700" BORDER="0" align="center" id=borde>
      <TR>
        <TD HEIGHT="20"><h3><bean:message key="canalesForm.header"/></h3></TD>
      </TR>
    </TABLE>    
<BR>
...
<logic:notEmpty name="CanalesForm" property="pcCveTipoCanal">
	...
	<TD>		<TABLE WIDTH="700" align="center">	<TR bgcolor="#FFFFFF">
		...
		<TR>
			...
			<fsj:generalHomeTable
				...
				titulos="Clave de Tipo de Canal, Clave Canal, Canales"
				metodos="getPcCveTpCanal,getPcCveCanal,getPcDescCanal"
				anchosColumnas="30%,30%, 30%"
	...
	<TD>		<TABLE WIDTH="700" align="center">	<TR bgcolor="#F9F9F9">
		...
		<TR BGCOLOR="#FFFFFF">
			<TD WIDTH="10%"  CLASS="txtContenidoRojo"><bean:message key="canalesForm.pcCveTipoCanal.displayname"/>:</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
