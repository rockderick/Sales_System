...
<TITLE><bean:message key="tipoCanalesForm.title"/></TITLE>
		...
		function validateForm(form){
			return (validateTipoCanalesForm(form));
		}
...
<BR><BR>
	<html:form method="post" action="TipoCanalesAction" method="POST"> 
	<bean:define id="TipoCanalesForm" name="TipoCanalesForm" type="mx.com.iusacell.catalogo.web.auxiliares.struts.action.TipoCanalesForm"/>
	...
	<TD BGCOLOR="#FFFFFF">
		...
		<TR>
		<TD HEIGHT="20"  CLASS="txtContenidoBlanco" ALIGN="CENTER" ><B><bean:message key="tipoCanalesForm.header"/></B></TD>
		</TR>
		</TABLE>
	</TD>
	</TR>
	...
	<TD>
		<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" BGCOLOR="#FFFFFF">		
		 <TR bgcolor="#FFFFFF">
			...
			<bean:message key="tipoCanalesForm.message"/>
			</TD>
		 </TR>
		<TR>
			...
			<fsj:generalHomeTable
				...
				witdhColumnRadio="10%"
				radioName="pcCveTpCanal"
				camposExtras='getPcDescTpCanal=desc'
				agregarValorCamposExtras='true'
				script="onClick='updateBox(TipoCanalesForm,this)'"
			/>
		 ...
		 <TR bgcolor="#FFFFFF">
				<TD WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
				<div id="eliminar" style="visibility:hidden"><html:button property="boton" styleClass="boton" onclick="goToEliminar(TipoCanalesForm)"><bean:message key="button.eliminar"/></html:button></div>
		 		</TD>
		 </TR>
<logic:present name="noData">
	...
	<TD>
		<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" BGCOLOR="#FFFFFF">		
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="tipoCanalesForm.pcDescTpCanal.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:text property="pcDescTpCanal" name="TipoCanalesForm" maxlength="40" size="30" onchange="this.value=this.value.toUpperCase()"/>
			</TD>
		</TR>
<logic:messagesPresent>
		...
		<TR bgcolor="#FFFFFF">
			<TD WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
				<html:button property="boton" styleClass="boton" onclick="goToAgregar(TipoCanalesForm)"><bean:message key="button.agregar"/></html:button>
			</TD>
			<TD WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
				<html:button property="boton" styleClass="boton" onclick="goToModificar(TipoCanalesForm)"><bean:message key="button.modificar"/></html:button>
		 	</TD>
		</TR>
		</TABLE>
	</TD>
...
<!--html:javascript formName="TipoCanalesForm" dynamicJavascript="true" staticJavascript="true"/--> 
</BODY>
</html:html>
