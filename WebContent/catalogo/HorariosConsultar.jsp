...
<BODY bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="3" marginwidth="0" marginheight="0" onLoad="window_onload(HorariosForm)">
	...
	<TABLE WIDTH="700" BORDER="0" align="center">
      ...
      <TR>
		...
		<TABLE WIDTH="70%" BORDER="0" CELLSPACING="1" CELLPADDING="0" BGCOLOR="#EEEEEE" align="center">
		<TR>
	...
	<TABLE WIDTH="700" BORDER="0" align="center">
		...
		<TD WIDTH="40%" height="40" ALIGN="CENTER" CLASS="txtContenido">
			<html:button property="boton" styleClass="boton" onclick="goToRegresar(HorariosForm)">Regresar</html:button>
		</TD>
		<td></td>
		</TR>
	 </TABLE>
