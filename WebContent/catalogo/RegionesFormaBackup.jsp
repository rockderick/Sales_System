...
<TITLE><bean:message key="regionesForm.title"/></TITLE>
		...
		function validateForm(form){
			return (validateRegionesForm(form));
		}
...
<BR><BR>
	<html:form method="post" action="RegionesAction" method="POST"> 
	<bean:define id="RegionesForm" name="RegionesForm" type="mx.com.iusacell.catalogo.web.auxiliares.struts.action.RegionesForm"/>
	...
	<TD BGCOLOR="#FFFFFF">
		...
		<TR>
		<TD HEIGHT="20"  CLASS="txtContenidoBlanco" ALIGN="CENTER" ><B><bean:message key="regionesForm.header"/></B></TD>
		</TR>
		</TABLE>
	</TD>
	</TR>
	...
	<TD>
		<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" BGCOLOR="#FFFFFF">		
		 <TR bgcolor="#FFFFFF">
			...
			<bean:message key="regionesForm.message"/>
			</TD>
		 </TR>
		<TR>
			...
			<fsj:generalHomeTable
				queryId="<%=Q.REGIONES_ALL%>"				
				valueMethodName = "getPcCveRegion"
				VOClass = "<%=mx.com.iusacell.catalogo.modelo.Pc_RegionesVO.class%>"
				border="1"
				width="60%"
				cellpadding="0"
				cellspacing="0"
				...
				witdhColumnRadio="10%"
				radioName="pcCveRegion"
				camposExtras='getPcDescRegion=desc'
				agregarValorCamposExtras='true'
				script="onClick='updateBox(RegionesForm,this)'"
			/>
		 ...
		 <TR bgcolor="#FFFFFF">
				<TD WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
				<div id="eliminar" style="visibility:hidden"><html:button property="boton" styleClass="boton" onclick="goToEliminar(RegionesForm)"><bean:message key="button.eliminar"/></html:button></div>
		 		</TD>
		 </TR>
<logic:present name="noData">
	...
	<TD>
		<TABLE WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="3" BGCOLOR="#FFFFFF">		
		<TR BGCOLOR="#E0E1E3">
			<TD WIDTH="10%"  CLASS="txtContenidoBold"><bean:message key="regionesForm.pcDescRegion.displayname"/> :</TD>
			<TD WIDTH="40%" ALIGN="LEFT" CLASS="PTabData">
				<html:text property="pcDescRegion" name="RegionesForm" maxlength="40" size="30" onchange="this.value=this.value.toUpperCase()"/>
			</TD>
		</TR>
<logic:messagesPresent>
		...
		<TR bgcolor="#FFFFFF">
			<TD WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
				<html:button property="boton" styleClass="boton" onclick="goToAgregar(RegionesForm)"><bean:message key="button.agregar"/></html:button>
			</TD>
			<TD WIDTH="40%" ALIGN="CENTER" CLASS="txtContenido">
				<html:button property="boton" styleClass="boton" onclick="goToModificar(RegionesForm)"><bean:message key="button.modificar"/></html:button>
		 	</TD>
		</TR>
		</TABLE>
	</TD>
