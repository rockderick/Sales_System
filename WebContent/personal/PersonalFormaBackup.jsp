				...
				<tr><td CLASS="txtContenidoBold"><bean:message key="personalForm.pcFchCambio.displayname" /> <bean:message key="mascara.fecha"/>: </td>
				    <td CLASS="txtContenido"><html:text property="pcFchCambio" name="PersonalForm" maxlength="10" size="10" onchange="this.value=this.value.toUpperCase()"/>
				        <a href="javascript:show_calendar('PersonalForm.pcFchCambio','','','DD/MM/YYYY','es')">
  				        <img src="../images/calendario.gif" alt="Haz click en el Calendario para elegir la fecha" width="14" height="16" border="0" style="cursor:hand" > </a></td>
				    <td CLASS="txtContenido"><html:button property="boton" styleClass="boton" onclick="goToModificar(PersonalForm)"><bean:message key="button.modificar"/></html:button></td>
				</tr></table>
			</TD>
		</TR>
		</TABLE>
...
<!--html:javascript formName="PersonalForm" dynamicJavascript="true" staticJavascript="true"/-->
</BODY>
</html:html>
